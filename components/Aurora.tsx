...
void main() {
  ...
  // Hapus perkalian 'intensity' agar warna tidak menjadi gelap/hitam.
  // Gunakan murni rampColor, lalu biarkan auroraAlpha yang mengatur transparansinya.
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      if (program) {
        ...
        if (currentStops !== cachedStopsRef) {
          cachedStopsRef = currentStops;
          cachedStopsArray = currentStops.map((hex: string) => {
            const c = new Color(hex);
            return [c.r, c.g, c.b];
          });
        }
